...
session_start();
$page_title = "Large Grain: Former Allies";
...
<div id="wrapper">
	<article class="item">
		<h6>
			In the legend to the left: &nbsp Click on the box next to the country label to show or hide data from a given country. &nbsp <br>
...
<script src="node_modules/RAS_added/linegraphLargeGrain_Allies.js"></script>
</body>
</html>
